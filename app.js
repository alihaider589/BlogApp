...
app.get('/', (req, res) => {
  res.render('home', { content: homeStartingContent, contentPosts: Posts })
})
...
app.get('/posts/:post', (req, res) => {
  ...
  const ReqTitle = _.lowerCase(req.params.post)



  Posts.forEach(function (post) {
    const PostPageTitle = _.lowerCase(post.Title)
    if (PostPageTitle === ReqTitle) {
